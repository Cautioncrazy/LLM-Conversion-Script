...
class ConverterGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Combobox(config_frame, textvariable=self.model_type_var, values=["GEMMA", "PHI_2", "FALCON_1B", "LLAMA"], state="readonly", width=15).grid(row=3, column=1, padx=10, sticky=tk.W, pady=5)
